...
if(isset($_POST['update'])){
    ...
    mysqli_query($conn, "UPDATE `cart` SET `total`='$total_price' WHERE `id`='$update_cart_id'") or die('query failed');
    ...
    ?>
        <table style="width: 70%; align-items:center; margin:10px auto;" >
            ...
            <tbody>
                ...
                <?php
                $total = 0;
                $select_book = $conn->query("SELECT id, name,price, image ,total  FROM cart Where user_id= $user_id");
                ...
                ?>
                        <tr>
                            ...
                            <td><?php $sub_total=$row['price']; echo 'Rs.'.$subtotal=number_format($row['price']). '/-'; ?></td>
                            </tr>
        ...
        <a class="cart-btn2"  <?php echo ($total == 0) ? 'centered' : ''; ?> style="display: flex; max-width: 200px;margin: 0 auto;justify-content: center;" href="index.php">Continue Shoping</a>
    </div>
