...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Subscription Date : <span><?php echo $fetch_book['order_date']; ?></span> </p>
         <p> Subscription Id : <span># <?php echo $fetch_book['order_id']; ?> </p>
         ...
         <p> Your Subscriptions : <span><?php echo $fetch_book['total_books']; ?></span> </p>
      ...
      <?php
         ...
         echo '<p class="empty">You have do not have any Subscriptions yet!!!!</p>';
      }
      ?>
   </div>
