      ...
      //   }
        ...
        if (mysqli_num_rows($cart_query) > 0) {
          while ($cart_item = mysqli_fetch_assoc($cart_query)) {
            ...
            mysqli_query($conn, "INSERT INTO `orders`(user_id,id,address,city,state,country,pincode,book,quantity,unit_price,sub_total) VALUES('$user_id','$conn_oid','$address','$city','$state','$country','$pincode','$cart_books','$unit_price','$sub_total')") or die('query failed');
          }
        }
...
<body>
  ...
  <p style="text-align: center; ">Just One Step away from Popcorn & Chill</p>
  <div class="row">
    <div class="col-75">
      <div class="container">
            ...
            <div class="col-50">
              <div class="col-25">
                <div class="container">
                  ...
                  ?>
                      <p> <a href="book_details.php?details=<?php echo $fetch_cart['book_id']; ?>"><?php echo $fetch_cart['name']; ?></a><span class="price">(<?php echo 'Rs. ' . $fetch_cart['price']; ?>)</span> </p>
                  <?php
                    }
                  } else {
